...
<div class="container my-2">
    <form action="<?= base_url('admin/profile_update/' . $id_pegawai['id']); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <input type="file" id="foto_pegawai" name="foto_pegawai" hidden>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" id="nama" name="nama" value="<?= $peg['nama']; ?>">
